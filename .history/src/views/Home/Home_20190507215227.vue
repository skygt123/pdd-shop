<template>
  <div class="home">
    ...
    <div slot="content">
      ...
      <cube-slide ref="slide" :data="tabLabels" @change="changePageTop">
        <cube-slide-item v-for="(tabLabel, index) in tabLabels" :key="index" @click.native="clickHandlerTop(item, index)">
          {{tabLabels.label}}1111
        </cube-slide-item>
      </cube-slide>
