...
<script>
const ContentW = document.querySelector('.nav-content-inner').offsetWidth
const BarW = document.querySelector('.hot-nav-bottom').offsetWidth
export default {
  data () {
    return {
      // 1. 屏幕的宽度
