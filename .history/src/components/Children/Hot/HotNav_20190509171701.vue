...
<script>
// const ContentW = document.querySelector('.nav-content-inner').clientWidth
// const BarW = document.querySelector('.hot-nav-bottom').clientWidth
console.log(document.querySelector('.hot-nav-bottom'))
console.log(document.querySelector('.nav-content-inner'))
export default {
  data () {
    return {
      // 1. 屏幕的宽度
  ...
  mounted () {
    console.log(document.querySelector('.hot-nav-bottom').offsetWidth)
    this.bgBarW = document.querySelector('.hot-nav-bottom').clientWidth
    this.scrollContentW = document.querySelector('.nav-content-inner').clientWidth
